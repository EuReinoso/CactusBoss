...
objs_mng.add_obj('cactus1', Cactus1(0, 0, 80, 80, ANIMATIONS['cactus_idle'][0]))

#OBJS CONFIG
OBJS = objs_mng.objs.copy()
    #player
OBJS['player'].add_imgs_data(ANIMATIONS['player_idle'], 'idle', [15, 15])
OBJS['player'].add_imgs_data(ANIMATIONS['player_run'], 'run', [15, 15])
OBJS['player'].action = 'idle'
    #cactus1
OBJS['cactus1'].add_imgs_data(ANIMATIONS['cactus_idle'], 'idle', [15, ])